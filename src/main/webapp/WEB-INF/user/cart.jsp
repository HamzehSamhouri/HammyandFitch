...
<head>
    ...
    <title>Hammy and Fitch Cart</title>
</head>
...
<body>
    ...
    <!-- CART -->
    <c:choose>
        <c:when test="${products.size() == 0 || userId == null}" >
                <div class="cart" style=" margin: 15vh 0vh 40vh 20vh; display: inline-block;">
                    <h1>Your Cart is Empty</h1>
                    <p>
                        <a href="/mensclothing">Shop Mens</a>
                        |
                        <a href="/womensclothing">Shop Womens</a>
                    </p>
                </div>
        </c:when>
        <c:otherwise>
            ...
            <div class="cart">
                <c:forEach var="product" items="${products}">
                    <c:if test="${userId == product.shopper.id}">
                        <div class="clothingitems">
                            <img src="${product.primaryimage}" alt="${product.title}">
                            <h3>${product.title}</h3>
                            <p class='mutedtext'>$${product.price}</p>
                            <a style="color: maroon;" href="products/${product.id}/return">Remove From Cart</a>
                        </div>
                    </c:if>
                </c:forEach>
            </div>
...
<!-- FOOTER -->
    <div class="footer">
        <a class="footerlogo" href="/">
            <h1>Abercrombie<span>&</span>Fitch</h1>
        </a>
        <div class='socialmediaicons'>
            <a>
                <img src="https://img.icons8.com/ios-glyphs/1000/253746/twitter--v1.png"
                    alt='Twitter Icon' />
            </a>
            <a>
                <img src="https://img.icons8.com/ios-glyphs/1000/253746/facebook-new.png"
                    alt='Facebook Icon' />
            </a>
            <a>
                <img src="https://img.icons8.com/ios/1000/253746/instagram-new--v1.png"
                    alt='Instagram Icon' />
            </a>
            <a>
                <img src="https://img.icons8.com/windows/1000/253746/pinterest-p.png"
                    alt='Pinterest Icon' />
            </a>
            <a>
                <img src="https://img.icons8.com/material-rounded/1000/253746/youtube-play.png"
                    alt='Youtube Icon' />
            </a>
            <a>
                <img src="https://img.icons8.com/ios-glyphs/1000/253746/tiktok.png"
                    alt='TikTok Icon' />
            </a>
        </div>
    </div>
